...
export const POST = async (request) => {
  ...
  const initiateData = {
    ...
    success_url: `${process.env.NEXT_PUBLIC_BASE_URL}/payment/api/success`,
    fail_url: `${process.env.NEXT_PUBLIC_BASE_URL}/payment/api/fail`,
    cancel_url: `${process.env.NEXT_PUBLIC_BASE_URL}/payment/api/cancel`,
